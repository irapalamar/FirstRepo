...
/**
 * Created by sbt-palamar-iy on 12.07.2018.
 */
public class TestLinkedList {
    ...
    /*
    1. Написать упрощенное подобие системы контроля версий посредством аннотаций:
1.1. Написать аннотацию Date, которая будет иметь три поля: day, month, year (например, типа int).
1.2. Написать аннотацию Version, которая будет содержать следующие поля: value (номер версии), creationDate, author, previous (ссылка на предыдущую версию класса).
1.3. Создать парочку классов, которые необходимо снабдить аннотацией Version.
1.4. Написать программу, которой на основе полученного экземпляра класса выведет всю историю изменений данного класса, т.е. рекурсивно обойдет все его предыдущие версии и выведет информацию по ним.
     */
}
